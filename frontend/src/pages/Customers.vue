    ...
    <nav class="text-sm font-semibold mb-6" aria-label="Breadcrumb">
        <ol class="list-none p-0 inline-flex">
            ...
            <li class="flex items-center">
                <a href="#" class="text-gray-600">Customers</a>
            </li>
        </ol>
    </nav>
     <div class="create-btn">
           <router-link to="/dashboard/customers/add"><button class="form-btn">Create Customer</button></router-link>
     </div>
     <table class="table-standard">
        ...
        <tbody>
            <tr v-for="customer in customers" :key="customer.id">
                ...
                <td class="table-cell">{{customer.mobile_number}}</td>
                <td class="table-cell">{{customer.address}}</td>
        
                <td class="table-cell">
                    <button class="bg-green-500 hover:bg-green-600 focus:outline-none action-btn">
                    ...
                    <button class="bg-red-500 hover:bg-red-600 focus:outline-none action-btn">
                        <svg class="h-6 w-6 fill-current" viewBox="0 0 20 20">
